...
public class kroco extends Character {
    SpriteBatch batch;
        Texture moveSheet;
        public Animation<TextureRegion> standbyAnimation;
        public Animation<TextureRegion> walkAnimation;
        TextureRegion[] karaktergerak = new TextureRegion[7];
    ...
    public void create () {
            ...
            moveSheet = new Texture(Gdx.files.internal("kroco.png"));
            TextureRegion[][] textureRegion = TextureRegion.split(moveSheet,64,40);
            for ( int i = 0 ; i < 7 ; i++ ){
