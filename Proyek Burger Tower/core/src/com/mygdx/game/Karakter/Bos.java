...
public class Bos extends Character {
    SpriteBatch batch;
        Texture moveSheet;
        public Animation<TextureRegion> standbyAnimation;
        public Animation<TextureRegion> walkAnimation;
        TextureRegion[] karaktergerak = new TextureRegion[4];
    ...
    public void create () {
            ...
            moveSheet = new Texture(Gdx.files.internal("bos4.png"));
            TextureRegion[][] textureRegion = TextureRegion.split(moveSheet,281,400);
            for ( int i = 0 ; i < 4 ; i++ ){
