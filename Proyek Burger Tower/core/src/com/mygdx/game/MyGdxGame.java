...
public class MyGdxGame extends ApplicationAdapter implements Screen{
    ...
    public MyGdxGame () 
    {
        ...
        dropSound = Gdx.audio.newSound(Gdx.files.internal("zsplat.mp3"));
        rainMusic = Gdx.audio.newMusic(Gdx.files.internal("jazzyfrenchy.mp3"));
    ...
    { 
        deltaTime+= Gdx.graphics.getDeltaTime() + 0.3;
            ...
            //cetak score
            str = "" + score;
            fontx.setColor(Color.BLACK);
            fontx.getData().setScale(2, 2);
            fontx.draw(batch, str, 700, 600);
            //print isi turun
            ...
            if(Gdx.input.isKeyPressed(Input.Keys.LEFT)) {
                ...
                me.setCurrentState(ninja.CharacterState.WALKING);
                me.setDirection(ninja.CharacterDirection.LEFT);
            }
            if(Gdx.input.isKeyPressed(Input.Keys.RIGHT)) {
                bucket.x += 400 * Gdx.graphics.getDeltaTime();aarah=3;
                me.setCurrentState(ninja.CharacterState.WALKING);
                me.setDirection(ninja.CharacterDirection.RIGHT);
            }
