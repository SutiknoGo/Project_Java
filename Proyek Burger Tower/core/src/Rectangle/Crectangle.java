...
public class Crectangle implements Serializable, Shape2D {
private int jenis;
	...
	public Crectangle (Rectangle rect) {
		x = rect.x;
		y = rect.y;
		width = rect.width;
		height = rect.height;
	...
	public Crectangle set (float x, float y, float width, float height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	 ...
	 * @return this rectangle for chaining */
	public Crectangle setX (float x) {
		this.x = x;
	 ...
	 * @return this rectangle for chaining */
	public Crectangle setY (float y) {
		this.y = y;
	 ...
	 * @param width The width
	 * @return this rectangle for chaining */
	public Crectangle setWidth (float width) {
		this.width = width;
	 ...
	 * @param height The height
	 * @return this rectangle for chaining */
	public Crectangle setHeight (float height) {
		this.height = height;
	 ...
	 * @return this rectangle for chaining */
	public Crectangle setPosition (Vector2 position) {
		this.x = position.x;
		this.y = position.y;
	 ...
	 * @param y The y-coordinate
	 * @return this rectangle for chaining */
	public Crectangle setPosition (float x, float y) {
		this.x = x;
		this.y = y;
	 ...
	 * @param height The height
	 * @return this rectangle for chaining */
	public Crectangle setSize (float width, float height) {
		this.width = width;
		this.height = height;
	 ...
	 * @return this rectangle for chaining */
	public Crectangle setSize (float sizeXY) {
		this.width = sizeXY;
		this.height = sizeXY;
	...
	public boolean overlaps (Crectangle r) {
	 ...
	 * @return this rectangle for chaining */
	public Crectangle set (Rectangle rect) {
		this.x = rect.x;
		this.y = rect.y;
	 ...
	 * @param rect the other rectangle
	 * @return this rectangle for chaining */
	public Crectangle merge (Rectangle rect) {
	 ...
	 * @return this rectangle for chaining */
	public Crectangle merge (float x, float y) {
	 ...
	 * @return this rectangle for chaining */
	public Crectangle merge (Vector2 vec) {
	 ...
	 * @return this rectangle for chaining */
	public Crectangle merge (Vector2[] vecs) {
		float minX = x;
		float maxX = x + width;
		float minY = y;
		float maxY = y + height;
	...
	public Crectangle setCenter (float x, float y) {
	 ...
	 * @return this for chaining */
	public Crectangle setCenter (Vector2 position) {
	 ...
	 * @return this rectangle for chaining
	 * @see Scaling */
	public Crectangle fitOutside (Rectangle rect) {
	 ...
	 * @return this rectangle for chaining
	 * @see Scaling */
	public Crectangle fitInside (Rectangle rect) {
		float ratio = getAspectRatio();
	 ...
	 * @param v the string.
	 * @return this rectangle for chaining */
	public Crectangle fromString (String v) {
		int s0 = v.indexOf(',', 1);
